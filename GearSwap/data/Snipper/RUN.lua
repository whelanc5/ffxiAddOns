...
----------------------------------------------------------------------Base sets-------------------------------------------------------------------------------
	...
	sets.base = {head="Herculean Helm",neck="Anu Torque",
         ear1="Brutal Earring",ear2="Sherida Earring",body="Rawhide Vest",hands="Herculean Gloves",
        ring1="Niqmaddu Ring",ring2="Epona's Ring", waist="Ioskeha Belt",legs= hercLegsTA,
        feet= hercFeetTA}
	--------------------------------------------------WS-----------------------------------------------------------------------
	sets.WS = set_combine(sets.base,{body="Meg. Cuirie +1", hands="Meg. Gloves +1",body="Meg. Cuirie +1",  legs = "Meghanada Chausses +2",ear1 ="Moonshade Earring" , head="Meghanada Visor +1"})
	...
	------------------------------------------DT-----------------------------------------------------------------------------------------------
	sets.DT = set_combine(sets.base,{back="Moonbeam Cape", neck="Twilight Torque",body="Futhark Coat +1", ring1="Dark Ring", ring2="Defending Ring", head="Meghanada Visor +1", hands="Meg. Gloves +1", waist = "Flume Belt"})
